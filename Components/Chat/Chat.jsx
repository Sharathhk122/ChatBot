...
const Chat = () => {
  ...
  const [messages, setMessages] = useState([]); // State to capture chat messages
  ...
  useEffect(() => {
    // Clear messages when active tool changes
    setMessages([]);
  }, [active]);
      ...
      <div className="main-wrapper">
        ...
        <div className="main-chat">
          <Form
            ...
            freeTrail={freeTrail}
            messages={messages}
            setMessages={setMessages} // Pass setMessages to clear chat
          />
        </div>
      </div>
    </div>
